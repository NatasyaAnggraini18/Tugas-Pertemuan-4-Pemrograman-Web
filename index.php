<?php
    ...
    <body>
    <div class="container">
    <h3><center>DATA PENJUALAN</h3>

    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">

    <div class="form-group">
        <label class="form-label" for="tanggal_penjualan">Tanggal Penjualan:</label>
        <input class="form-control"type="date" id="tanggal_penjualan" name="tanggal_penjualan" required>
    </div>
    ...
    echo "<h3><center>TABEL DATA PENJUALAN</h3>";
    echo "<table>";
